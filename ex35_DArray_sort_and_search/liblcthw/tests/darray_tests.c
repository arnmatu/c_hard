...
char *test_create()
{
  ...
  mu_assert(array->end == 0, "end is not at a right spot");
...
char *test_remove()
{
  ...
  printf("TEST REMOVE *val_check0 = %d *val1 = %d", *val_check, *val1);
  ...
  printf("TEST REMOVE *val_check1 = %d", *val_check);
  mu_assert(val_check != NULL, "Should not get NULL");
